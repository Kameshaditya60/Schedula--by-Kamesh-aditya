...
let PatientProfileController = class PatientProfileController {
    ...
    async createOrUpdatePatientProfile(req, dto) {
        return this.service.createOrUpdatePatientProfile(req.user.user_id, dto);
    }
};
exports.PatientProfileController = PatientProfileController;
__decorate([
    (0, common_1.UseGuards)(jwt_guard_1.JwtAuthGuard, roles_guard_1.RolesGuard),
    (0, roles_decorator_1.Roles)(roles_enum_1.Role.PATIENT),
    (0, common_1.Post)('profile'),
    __param(0, (0, common_1.Req)()),
    __param(1, (0, common_1.Body)()),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [Object, patient_profile_dto_1.CreatePatientProfileDto]),
    __metadata("design:returntype", Promise)
], PatientProfileController.prototype, "createOrUpdatePatientProfile", null);
